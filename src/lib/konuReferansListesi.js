...
export const KONU_REFERANS = {
  ...
  Biyoloji: [
    ...
    'Hücre Zarından Madde Geçişi', 'Canlıların Sınıflandırılması', 'Mitoz',
    'Mayoz', 'Kalıtım', 'Genetik', 'DNA ve Genetik Şifre', 'Ekosistem Ekolojisi',
    ...
    'Bitki Biyolojisi', 'İnsan Fizyolojisi', 'Genden Proteine', 'Biyoteknoloji',
